...
- [x] [笔记持久化与笔记按钮 UI 状态指示](./docs/feature-plan/2026-0617-Note_Persistence_Plan.md)（2026-06-17 已完成）
    - [x] PopupActivity.java：删除添加卡片成功后清空笔记的代码（mNoteEditedByUser = ""）
    - [x] PopupActivity.java：新增 updateNoteButtonUI() 方法，有笔记内容时图标显示橙色色调+alpha 1.0，空时清色+alpha 0.4
    - [x] PopupActivity.java：在 setupEditNoteDialog() 确认回调、onResume()、添加卡片成功处调用 updateNoteButtonUI()
